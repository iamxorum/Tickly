...
public class TicketController {
    ...
    @Operation(
        ...
        description = "Retrieves all tickets with optional filtering and pagination"
    )
    @ApiResponses({
    ...
    public ResponseEntity<TicketDTO> getTicketById(
            @Parameter(description = "ID of the ticket to retrieve") 
    ...
    public ResponseEntity<TicketDTO> updateTicketStatus(
            ...
            @PathVariable Long id,
            @Parameter(description = "New status", schema = @Schema(type = "string", allowableValues = {"OPEN", "IN_PROGRESS", "RESOLVED", "CLOSED"})) 
    ...
    public ResponseEntity<Void> deleteTicket(
            @Parameter(description = "ID of the ticket to delete") 
            @PathVariable Long id) {
